...
HD_PWD='/home/hyeonjun/AMD/Vivado/source/camera2hdmi_final1.02/camera2hdmi_final.runs/design_1_rgb2dvi_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rgb2dvi_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rgb2dvi_0_3.tcl
